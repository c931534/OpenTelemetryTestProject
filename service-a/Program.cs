        ...
        tracerProviderBuilder
            ...
            .SetResourceBuilder(
                ResourceBuilder.CreateDefault()
                    .AddService("frontend-member-service"))
            .AddOtlpExporter(opt =>
            {
...
var counter = meter.CreateCounter<int>("frontend_member_test_counter");
var callBCounter = meter.CreateCounter<int>("frontend_promotion_requests_total");
...
// ✅ 註冊路由
app.MapGet("/", () => "Frontend Member Service A is running");

app.MapGet("/api/test-metric", () =>
{
    counter.Add(1, KeyValuePair.Create<string, object?>("label", "test"));
    return Results.Ok("Frontend Member Metric incremented");
});
